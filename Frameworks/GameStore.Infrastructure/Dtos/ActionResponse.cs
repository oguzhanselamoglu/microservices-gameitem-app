...
namespace GameStore.Infrastructure.Dtos
{
    public class ActionResponse<T>
    {
        ...
        {
            return new ActionResponse<T> { Data = data, StatusCode = statusCode, IsSuccessful = true };
        }

        public static ActionResponse<T> Success(int statusCode)
        {
            return new ActionResponse<T> { Data = default, StatusCode = statusCode, IsSuccessful = true };
        }
        ...
        public static ActionResponse<T> Fail(string error, int statusCode)
        {
            ...
            return new ActionResponse<T> { Errors = new List<string> { error }, Data = default, StatusCode = statusCode, IsSuccessful = false };
        }
    }
}
